<template>
    <div class="question">
        ...
        <h3 class="question__progress">Question {{questionId + 1}} of {{questionsCount}}</h3>
        ...
        <button :disabled="submitDisabled()" class="question__submit" href="#" @click.prevent="submitAnswer()">Submit Answer!</button>
        <p class="question__score"><i class="fa fa-leaf" aria-hidden="true"></i> Score: {{score}}</p>
        <p class="question__reset"><a href="#" @click.prevent="startOver()"><i class="fas fa-redo"></i>Start Over</a></p>
    </div>
</template>
