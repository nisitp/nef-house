<template>
    <div class="characterSelect">
      <div class="characterSelect__intro">
        <h1 class="characterSelect__title">Play the Energy Efficiency Game!</h1>
        <p class="characterSelect__desc">Explore the home by dragging it around and clicking on the bubbles to get energy efficiency tips. Then, see how much you've learned&mdash;how high can you score?</p>
        <hr class="characterSelect__hr">
      </div>
        <h2 class="characterSelect__sub">Test Your Knowledge</h2>
        <p class="characterSelect__desc">Pick a character to get started:</p>
