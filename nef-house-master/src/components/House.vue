                ...
                <div v-for="tooltip in tooltips" class="house__tooltip" :class="[{'house__tooltip__active' : tooltipActive[tooltip.appliance + ',' + tooltip.room]}, 'house__'+(tooltip.appliance)+'__'+(tooltip.room)]" >
                    <span class="house__tooltip__icon"
                        :class="[{'layer' : tooltip.num > 1},
                                {'lightItRight' : tooltip.category === 'Light It Right'},
                                {'getSet' : tooltip.category === 'Get Set'},
                                {'sealItUp' : tooltip.category === 'Seal It Up'},
                                {'flowLow' : tooltip.category === 'Flow Low'},
                                {'turnItOff' : tooltip.category === 'Turn It Off'},
                                {'washItWell' : tooltip.category === 'Wash It Well'},
                                {'beSmart' : tooltip.category === 'Be Smart'},
                                {'didYouKnow' : tooltip.category === 'Did You Know?'},
                                {'keepItClean' : tooltip.category === 'Keep It Clean'}]" @click="openPopup($event)"></span>
